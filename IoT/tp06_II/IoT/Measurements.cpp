...
/*
measure_value measurements::get_measurement(uint8_t p_index) {
  measure_value measure = {0};
  measure.temperature = m_mea_avg[p_index].temperature;
  measure.humidity = m_mea_avg[p_index].humidity;
  return measure;
}
*/
