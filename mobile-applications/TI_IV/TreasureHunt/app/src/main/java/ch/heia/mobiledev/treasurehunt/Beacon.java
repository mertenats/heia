...
public class Beacon {
    ...
    public static void setNextBeacon(int nextBeacon) {
        next_beacon = nextBeacon;
    }
    ...
    private double calculateAccuracy() {
        return Math.pow(10d, ((double)txLevel - rssi) / (10 * 2.0));
    }
     ...
     */
    public static int calculateProximity(Beacon[] measure) {
        double accuracy = analyzeLastData(measure);
