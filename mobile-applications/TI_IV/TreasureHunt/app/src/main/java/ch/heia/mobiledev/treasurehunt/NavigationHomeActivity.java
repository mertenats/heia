...
public class NavigationHomeActivity extends AppCompatActivity {
     ...
     * @param v : source view
     */
    public void onNewGame(@SuppressWarnings("UnusedParameters") View v) {
     ...
     * @param v : source view
     */
    public void onLoadGame(@SuppressWarnings("UnusedParameters") View v) {
     ...
     * @param v : source view
     */
    public void onReadAbout(@SuppressWarnings("UnusedParameters") View v) {
