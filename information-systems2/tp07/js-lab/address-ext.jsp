...
<script src="js/validation-ext.js"></script>
...
<form action="#" id="addressform" method="POST" accept-charset="utf-8" >
  <table>
    ...
    <td id="address-errmsg" class="msg-error"></td>
      ...
      <!-- the following select tag is not visible initially -->
      <!-- use it to fill in options (city names) the user may choose from -->
      <select id="city-select" style="display: none; width: 150px;"></select>
	  </td>
