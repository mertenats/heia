...
@WebServlet(asyncSupported = true, urlPatterns = { "/rest/weatherstation/*" })
public class RestServlet extends HttpServlet {
	 ...
	 */
	public final static String COAP_PROXY_URL_PATTERN = "/TP5_CoapProxy";
	...
	private static HashMap<String, WebResource> getWeatherStationMap() {
		...
		// weatherStationMap.put("c10-12", new WeatherStation("C10-12",
		// "2004::247:C0ff:feC5:3E3D"));
		weatherStationMap.put("c10-16", new WeatherStation("C10-16", "2004::29c:fdff:fea0:5696"));
		//weatherStationMap.put("c10-22", new WeatherStation("C10-22","2004::23e:87ff:fec4:f1e1"));
	...
	protected void doGet(HttpServletRequest httpRequest, HttpServletResponse httpResponse)
		...
		if (httpUri.equalsIgnoreCase(COAP_PROXY_URL_PATTERN + REST_URL_PATTERN + WEATHERSTATION_URL_PATTERN) || httpUri
			...
			System.out.println("Header accept : " + httpRequest.getHeader("accept"));
			if (httpRequest.getHeader("accept").equals("text/event-stream") ) {
				webResource.writeObserveResponse(getResourcePath(httpRequest), httpResponse, httpRequest);				
			} else {
