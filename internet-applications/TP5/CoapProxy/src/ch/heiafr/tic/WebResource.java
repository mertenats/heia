...
interface WebResource {
	 ...
	 */
	// public abstract void serialize(ServletOutputStream outputStream) throws
	// IOException, ServletException;
	public abstract String serialize();

	public abstract void writeObserveResponse(String resourcePath, HttpServletResponse httpResponse,
