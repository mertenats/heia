...
class WeatherStation implements WebResource {
	...
	private final static String[] SENSOR_DEFAULT_VALUE_ARRAY = { "1", "45", "850" };
	...
	public WeatherStation(String m_weatherStationLocation, GsonBuilder m_gsonBuilder, String p_temperature,
			String p_humidity, String p_pressure) {
		this.m_weatherStationLocation = m_weatherStationLocation;
		this.m_gsonBuilder = m_gsonBuilder;
		// state
		this.m_state = new State(false);

		// sensors
		Sensor l_temperatureSensor = new Sensor(SENSOR_ID_ARRAY[0], SENSOR_UNIT_ARRAY[0], p_temperature);
		Sensor l_humiditySensor = new Sensor(SENSOR_ID_ARRAY[1], SENSOR_UNIT_ARRAY[1], p_humidity);
		Sensor l_pressureSensor = new Sensor(SENSOR_ID_ARRAY[2], SENSOR_UNIT_ARRAY[2], p_pressure);
