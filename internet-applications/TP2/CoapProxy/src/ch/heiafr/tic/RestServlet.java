...
public class RestServlet extends HttpServlet {
	 ...
	 */
	public final static String COAP_PROXY_URL_PATTERN = "/TP2_CoapProxy/";
	...
	private static HashMap<String, WebResource> getWeatherStationMap() {
		...
		WeatherStation l_weatherStation1 = new WeatherStation(WEATHER_STATION_INITIAL_LOCATIONS[0], m_gsonBuilder);
		WeatherStation l_weatherStation2 = new WeatherStation(WEATHER_STATION_INITIAL_LOCATIONS[1], m_gsonBuilder);
